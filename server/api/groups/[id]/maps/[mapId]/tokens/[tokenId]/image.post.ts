/**
 * POST /api/groups/:id/maps/:mapId/tokens/:tokenId/image — Token-Bild hochladen.
 * Owner des Tokens oder DM. Speichert in Vercel Blob, setzt imageUrl.
 */
...
export default defineEventHandler(async (event) => {
  ...
  const blobPath = `battle-tokens/${groupId}/${mapId}/${filename}`
